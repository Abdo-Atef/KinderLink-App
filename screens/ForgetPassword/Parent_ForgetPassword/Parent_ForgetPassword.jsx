...
export default function Parent_ForgetPassword() {
  ...
  async function forgetSubmit(values) {
    ...
    const { data } = await axios.patch(
      `${BASE_URL}/childeren/forgetPassword`,
      values
    );
    console.log(data);
    if (data.sucess) {
      ...
      setApiError("The Email is not correct");
      setApiSuccess(null);
    }
    setIsLoading(false);
  }
        ...
        <ScrollView>
          <View style={styles.innerContainer}>
            ...
            >
              ...
              <Text style={{ fontWeight: "500", fontSize: wp(14), marginHorizontal:wp(5), textDecorationLine:'underline' }}>
                Back To Login
              </Text>
            </Pressable>
          </View>
