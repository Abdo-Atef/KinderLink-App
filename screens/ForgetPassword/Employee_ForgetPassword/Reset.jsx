...
export default function Reset() {
  ...
  async function handleResetSubmit(values, { resetForm }) {
    setIsLoading(true);
    const {data} = await axios.patch(`${BASE_URL}/employees/getCode`, values);
    console.log(data);
    if (data.sucess) {
  ...
  return (
    <>
      ...
      <Formik
        initialValues={{ email: "", password: "", rePassword: "", code: "" }}
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              <CustomTextInput
                ...
                value={values.code}
                borderColor={errors.code && touched.code ? "red" : COLORS.blue}
              />
            ...
            <View style={styles.inputContainer}>
              ...
              <CustomTextInput
                ...
                borderColor={
                  errors.rePassword && touched.rePassword ? "red" : COLORS.blue
                }
              />
